...
type ImageUploadResponse struct {
	...
	CountentType string `protobuf:"bytes,3,opt,name=countent_type,json=countentType,proto3" json:"countent_type,omitempty"`
...
func (x *ImageUploadResponse) GetCountentType() string {
	if x != nil {
		return x.CountentType
	}
	return ""
}
...
var file_imageuploader_proto_rawDesc = []byte{
	...
	0x6e, 0x61, 0x6d, 0x65, 0x42, 0x06, 0x0a, 0x04, 0x66, 0x69, 0x6c, 0x65, 0x22, 0x7e, 0x0a, 0x13,
	...
	0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x12, 0x23, 0x0a, 0x0d, 0x63,
