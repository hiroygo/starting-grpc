...
func (x *ImageUploadRequest) Reset() {
	*x = ImageUploadRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_imageuploader_proto_msgTypes[0]
...
func (*ImageUploadRequest) Descriptor() ([]byte, []int) {
	return file_imageuploader_proto_rawDescGZIP(), []int{0}
}
...
func (x *ImageUploadResponse) Reset() {
	*x = ImageUploadResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_imageuploader_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ImageUploadResponse) Descriptor() ([]byte, []int) {
	return file_imageuploader_proto_rawDescGZIP(), []int{1}
}
...
func (x *ImageUploadRequest_FileMeta) Reset() {
	*x = ImageUploadRequest_FileMeta{}
	if protoimpl.UnsafeEnabled {
		mi := &file_imageuploader_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ImageUploadRequest_FileMeta) Descriptor() ([]byte, []int) {
	return file_imageuploader_proto_rawDescGZIP(), []int{0, 0}
}
...
var File_imageuploader_proto protoreflect.FileDescriptor

var file_imageuploader_proto_rawDesc = []byte{
	0x0a, 0x13, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x75, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x65, 0x72, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0d, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x75, 0x70, 0x6c, 0x6f,
	0x61, 0x64, 0x65, 0x72, 0x22, 0xa5, 0x01, 0x0a, 0x12, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x55, 0x70,
	0x6c, 0x6f, 0x61, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x49, 0x0a, 0x09, 0x66,
	0x69, 0x6c, 0x65, 0x5f, 0x6d, 0x65, 0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2a,
	...
	0x74, 0x2e, 0x46, 0x69, 0x6c, 0x65, 0x4d, 0x65, 0x74, 0x61, 0x48, 0x00, 0x52, 0x08, 0x66, 0x69,
	0x6c, 0x65, 0x4d, 0x65, 0x74, 0x61, 0x12, 0x14, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x0c, 0x48, 0x00, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x1a, 0x26, 0x0a, 0x08,
	0x46, 0x69, 0x6c, 0x65, 0x4d, 0x65, 0x74, 0x61, 0x12, 0x1a, 0x0a, 0x08, 0x66, 0x69, 0x6c, 0x65,
	0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x66, 0x69, 0x6c, 0x65,
	0x6e, 0x61, 0x6d, 0x65, 0x42, 0x06, 0x0a, 0x04, 0x66, 0x69, 0x6c, 0x65, 0x22, 0x7c, 0x0a, 0x13,
	...
	0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x63,
	...
	,
}

var (
	file_imageuploader_proto_rawDescOnce sync.Once
	file_imageuploader_proto_rawDescData = file_imageuploader_proto_rawDesc
)

func file_imageuploader_proto_rawDescGZIP() []byte {
	file_imageuploader_proto_rawDescOnce.Do(func() {
		file_imageuploader_proto_rawDescData = protoimpl.X.CompressGZIP(file_imageuploader_proto_rawDescData)
	})
	return file_imageuploader_proto_rawDescData
}

var file_imageuploader_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_imageuploader_proto_goTypes = []interface{}{
	(*ImageUploadRequest)(nil),          // 0: imageuploader.ImageUploadRequest
	(*ImageUploadResponse)(nil),         // 1: imageuploader.ImageUploadResponse
	(*ImageUploadRequest_FileMeta)(nil), // 2: imageuploader.ImageUploadRequest.FileMeta
}
...
func init() { file_imageuploader_proto_init() }
func file_imageuploader_proto_init() {
	if File_imageuploader_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_imageuploader_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_imageuploader_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_imageuploader_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	file_imageuploader_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_imageuploader_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_imageuploader_proto_goTypes,
		DependencyIndexes: file_imageuploader_proto_depIdxs,
		MessageInfos:      file_imageuploader_proto_msgTypes,
	}.Build()
	File_imageuploader_proto = out.File
	file_imageuploader_proto_rawDesc = nil
	file_imageuploader_proto_goTypes = nil
	file_imageuploader_proto_depIdxs = nil
}
